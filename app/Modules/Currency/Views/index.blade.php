                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <div align="right">
                                ...
                                @if(Input::has('name') || Input::has('code'))
                                    <a href="{{ URL::to('/currencies') }}" type="submit" class="btn btn-danger" style="color: black;"><i class="fa fa-redo"></i></a>
                                @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="كود العملة" value="{{ Input::get('code') }}">
                                </div>
                            </div>
                            <div class="col-xs-6 col-md-4">
                                <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <div class="row">
                        <div class="col-xs-6">
                            <h3>العملات<small> العدد الكلي : {{ $data->pagination->total_count }}</small></h3>
                        </div>
                        <div class="col-xs-6 text-right">
                            <ul class="nav navbar-right " style="padding-top: 1%">
                                @if(\Helper::checkRules('add-currency'))
                                    <a href="{{URL::to('/currencies/add')}}" class="btn btn-default" style="color: black;"><i class="fa fa fa-plus"></i> عملة جديدة</a>
                                @endif
                                <a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </ul>
                        </div>
                            ...
                            <tr id="tableRaw{{ $value->id }}">
                                ...
                                <td class="actions" width="15%" align="left">
                                    @if(\Helper::checkRules('edit-currency'))
                                        <a href="{{ URL::to('/currencies/edit/' . $value->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil-alt"></i> تعديل </a>
                                    @endif

                                    @if(\Helper::checkRules('delete-currency'))
                                        <a onclick="deleteCurrency('{{ $value->id }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> حذف </a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
...
@section('script')
    <script src="{{ asset('assets/components/currencies.js')}}"></script>
@stop()
